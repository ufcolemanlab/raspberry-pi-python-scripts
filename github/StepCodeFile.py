...
class StepCodeFile:
    def __init__(self, filename, codes, channels, frequency):
        ...
        self.event_channel = 2
        self.Bframe_channel = 3
        
        self.sampling_window = 50
        self.sampling_window_offset = 200
        
        self.max_voltage = max(self.data[2])
